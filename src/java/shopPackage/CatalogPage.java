...
public abstract class CatalogPage extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request,
    ...
    out.println("<a href=\"OrderPage\">Go to Shopping Cart</a>");
    out.println("<HR>\n</BODY></HTML>");
    }
    else
    {
        out.println(Catalog.htmlStartString(title) +
        "<H1 ALIGN=\"CENTER\">Not Logged In</H1>" + 
        "<h4 align=center>Please log in to see access all the items and functionality.</p>" + "</body></html>");
